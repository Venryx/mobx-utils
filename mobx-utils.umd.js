;(function(global, factory) {
    ...
    function createObservablePromise(origPromise, oldPromise) {
        ...
        origPromise.then(
            mobx.action("observableFromPromise-resolve", function(value) {
                promise.value = value
    ...
    var StreamListener = /** @class */ (function() {
        ...
        __decorate([mobx.action.bound], StreamListener.prototype, "next", null)
        __decorate([mobx.action.bound], StreamListener.prototype, "complete", null)
        __decorate([mobx.action.bound], StreamListener.prototype, "error", null)
    ...
    var ViewModel = /** @class */ (function() {
        ...
        __decorate$1([mobx.computed], ViewModel.prototype, "changedValues", null)
    ...
    function queueProcessor(observableArray, processor, debounce) {
        ...
        if (debounce > 0) return mobx.autorun(runner, { delay: debounce })
        else return mobx.autorun(runner)
    }
    ...
    function createAnimationFrameTicker() {
        var frameBasedTicker = fromResource(
            function(sink) {
                ...
                return Object.assign({}, descriptor_1, {
                    set: function(v) {
                        Object.defineProperty(
                            this,
                            name_1,
                            __assign$1(__assign$1({}, descriptor_1), { value: mobx.flow(v) })
                        )
                    }
                })
            }
    ...
    function isRecursivelyObservable(thing) {
        return (
            mobx.isObservableObject(thing) ||
            mobx.isObservableArray(thing) ||
            mobx.isObservableMap(thing)
        )
    }
    /**
    ...
    var $finalValue = Symbol("$finalValue")
    /**
     * @private
     */
 ...
 */
    function computedFn(fn, keepAliveOrOptions) {
        ...
        if (mobx.isAction(fn)) throw new Error("computedFn shouldn't be used on actions")
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        ;(runId = ctx.runId),
                            ...
                            (args = ctx.args),
                            (scope = ctx.scope),
                            (actionRunInfo = ctx.actionRunInfo),
                            (step = ctx.step)
                        nextStep = step + 1
                    ...
                    case 4:
                        ...
                        if (unfinishedIds.has(runId)) {
                            actionRunInfo_1 = mobx._startAction(
                ...
                return __generator(this, function(_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            actionRunInfo = mobx._startAction(
                                getActionAsyncName(actionName, nextRunId, 0),
                                this,
                                args
                            )
                            actionAsyncContextStack.push({
                            ...
                            finish = function(err) {
                                ...
                                if (!ctx || ctx.runId !== nextRunId) {
                                    ...
                                    var msg =
                                        "invalid 'actionAsync' context when finishing action '" +
                                        actionName +
                                        "'."
                                    if (!ctx) {
